...
const merchantNav: NavItem[] = [
  ...
  { label: '商户充值', path: '/recharge', icon: <Wallet size={16} />, hideForAdmin: true, feature: 'recharge' },
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems: NavItem[] = role === 'admin'
    ? [...adminNav, { label: "商户功能", path: "", icon: <span /> }, ...merchantVisibleNav.filter(n => !n.hideForAdmin)]
    : merchantVisibleNav;
